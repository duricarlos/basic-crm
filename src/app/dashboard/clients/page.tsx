      ...
      <div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
        ...
        <div className='flex items-center gap-2'>
          <div className='relative hidden md:block'>
            ...
            <Input type='search' placeholder='Buscar cliente...' className='pl-9 w-[250px] bg-white ring-offset-0 focus-visible:ring-0 focus-visible:border-primary' />
          </div>
          <NewClientDialog />
        </div>
      </div>
              ...
              clients.map((client) => {
                ...
                return (
                  <TableRow key={client.id} className='group hover:bg-gray-50 transition-colors cursor-pointer'>
                    ...
                    <TableCell>
                      <span className='text-xs text-gray-500 font-medium'>{lastActivityDate}</span>
                    </TableCell>
