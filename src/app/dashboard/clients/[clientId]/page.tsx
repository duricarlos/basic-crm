              ...
              <div>
                ...
                <Badge className="mt-1 text-base">
                  {client.status === 'new' ? 'Nuevo' : 
                   client.status === 'in_progress' ? 'En Proceso' : 
                   client.status === 'cancelled' ? 'Cancelado' : client.status}
                </Badge>
              </div>
              <Separator />
              <div>
                            ...
                            <li key={b.id} className="flex justify-between items-center p-3 bg-muted rounded-lg">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        {b.dateGenerated ? new Date(b.dateGenerated).toLocaleDateString() : 'Sin fecha'}
                                    </p>
                                </div>
