        ...
        <div className='flex items-center justify-between'>
          <div>
            <div className="flex items-center gap-2">
                ...
                {budget.status === 'draft' && <Badge variant="secondary" className="bg-zinc-100 text-zinc-600 hover:bg-zinc-200">Borrador</Badge>}
            </div>
          ...
          <div className='text-right'>
            ...
            <div className="flex items-center justify-end gap-3">
                 <p className='text-3xl font-black text-emerald-600 tracking-tight'>
                  {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(budget.total)}
                </p>
                            ...
                            <>
                                <DialogHeader className="p-6 pb-2 bg-zinc-50 border-b border-zinc-100">
                                    ...
                                    <DialogDescription className="text-base text-zinc-600 font-medium">
                                        Selecciona el nuevo estado para este presupuesto.
                                    </DialogDescription>
                                </DialogHeader>
                        ...
                        {view === 'reminder_prompt' && (
                             <>
                                <DialogHeader className="p-6 pb-2 bg-amber-50 border-b border-amber-100">
                                    ...
                                    <DialogDescription className="text-base font-medium text-amber-900/80">
                                        Configura el recordatorio de seguimiento para este presupuesto.
                                    </DialogDescription>
                                </DialogHeader>
                                     ...
                                     <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input 
                                                ...
                                                className="pl-10 h-12 text-lg font-medium border-2 border-zinc-200 focus-visible:ring-amber-500"
                                            />
                                        </div>
                                     </div>
                                     <div className="space-y-2">
                                        ...
                                        <Textarea 
                                            ...
                                            className="resize-none text-base border-2 border-zinc-200 focus-visible:ring-amber-500"
                                        />
                                     </div>
                        ...
                        {view === 'archive_confirm' && (
                            <>
                                 <DialogHeader className="p-6 pb-2 bg-red-50 border-b border-red-100">
                                    ...
                                    <DialogDescription className="text-base font-medium text-red-900/80">
          ...
          {STEPS.map((step, index) => {
            ...
            return (
              <div key={step.id} className='flex flex-col items-center gap-2 px-2 z-10'>
                ...
                <span 
                  className={cn(
                    'text-xs font-bold uppercase tracking-wider px-2 py-1 rounded-md text-center bg-white',
                    isCurrent ? 'text-emerald-700 bg-emerald-50' : 'text-zinc-500'
                  )}
                >
                  {step.label}
                </span>
