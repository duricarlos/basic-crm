      ...
      <DialogContent className="sm:max-w-lg bg-white border-2 border-zinc-200 p-0 gap-0 overflow-hidden">
        <DialogHeader className="p-6 pb-4 bg-zinc-50 border-b border-zinc-100">
          ...
          <DialogDescription className="text-base font-medium text-zinc-600">
            ¿Para quién es este nuevo presupuesto?
          </DialogDescription>
        </DialogHeader>
          ...
          <Command className="border-2 border-zinc-200 rounded-lg overflow-hidden">
            <div className="flex items-center border-b border-zinc-200 px-3 bg-white">
              ...
              <CommandInput 
                ...
                className="flex h-12 w-full rounded-md bg-transparent py-3 text-lg outline-none placeholder:text-zinc-400 disabled:cursor-not-allowed disabled:opacity-50"
              />
            </div>
            <CommandList className="max-h-[300px] overflow-y-auto p-2">
              <CommandEmpty className="py-6 text-center text-zinc-500 font-medium">
              ...
              <CommandGroup>
                {clients.map((client) => (
                  <CommandItem
                    ...
                    className="flex items-center justify-between p-3 mb-1 rounded-md cursor-pointer hover:bg-zinc-100 aria-selected:bg-zinc-100 transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        ...
                        {client.description && (
                            <span className="text-sm text-zinc-500 line-clamp-1">{client.description}</span>
                        )}
                      </div>
                    </div>
